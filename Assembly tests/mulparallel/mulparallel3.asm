...
#Perform A3 * B3, then A3 * B2
iLoop1:
	bge $imm, $r4, $r9, iLoop2					#pc:, if i >= N, exit iLoop1
	add $zero, $zero, $zero, 0					#pc:, nop
	add $r5, $r7, $zero, $zero, 0				#pc:, j = B
	jLoop1:
		bge $imm, $r5, $r9, jLoop1E				#pc:, if j >= N, exit jLoop1
		add $zero, $zero, $zero, 0				#pc:, nop
		add $r6, $r7, $zero, $zero, 0			#pc:, k = B
		add $r8, $zero, $zero, $zero, 0			#pc:, r = 0
		kLoop1:
			bge $imm, $r6, $r9, kLoop1E			#pc:, if k >= N, exit kLoop1
			add $zero, $zero, $zero, 0			#pc:, nop
...
#			r= r+ A[i][k]*B[k,j]
#		Z[i][j]= Z[i][j] + r
add $r4, $r7, $zero, 0							#pc:, i = B
iLoop2:
	bge $imm, $r4, $r9, iLoop2E					#pc:, if i >= N, exit iLoop2
	add $zero, $zero, $zero, 0					#pc:, nop
	add $r5, $zero, $zero, $zero, 0				#pc:, j = 0
	jLoop2:
		bge $imm, $r5, $r7, jLoop2E				#pc:, if j >= B, exit jLoop2
		add $zero, $zero, $zero, 0				#pc:, nop
		add $r6, $r7, $zero, $zero, 0			#pc:, k = B
		add $r8, $zero, $zero, $zero, 0			#pc:, r = 0
		kLoop2:
