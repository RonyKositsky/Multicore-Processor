...
add $r10, $imm, $zero, 3		#pc:0, R10 = 0 my core number is 3 
...
lw, $r5, $zero, $imm, 256		#pc:13, R5 = MEM[256], create conflict miss on relevant block 
halt, $zero, $zero, $zero, 0	#pc:14, HALT
